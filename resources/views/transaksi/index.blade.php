        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <div class="col-md-2 mb-4">
                    <a href="{{ route('tambahTransak') }}" class="btn btn-info waves-effect waves-light m-b-5"><img
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($item->status == "komfirmasi")
                                        <a data-action="{{ route('hapusTransaksi', $item->id) }}"
                                            ...
                                            class="hapus btn btn-icon waves-effect waves-light btn-danger m-b-5"><img
                                                ...
                                                width="20px" /> Hapus</a>
                                        <a data-action="{{ route('bukuKembali', $item->id) }}"
